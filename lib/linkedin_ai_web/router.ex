defmodule LinkedinAiWeb.Router do
  use LinkedinAiWeb, :router

  import LinkedinAiWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {LinkedinAiWeb.Layouts, :root}
  ...
  if Application.compile_env(:linkedin_ai, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: LinkedinAiWeb.Telemetry
  ...
  scope "/", LinkedinAiWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{LinkedinAiWeb.UserAuth, :redirect_if_user_is_authenticated}] do
